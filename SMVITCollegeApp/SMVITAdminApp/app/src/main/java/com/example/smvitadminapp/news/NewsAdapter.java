...
import com.example.smvitadminapp.news.NewsData;
...
public class NewsAdapter extends RecyclerView.Adapter<NewsAdapter.NewsViewAdapter> {
    ...
    @Override
    public void onBindViewHolder(@NonNull NewsViewAdapter holder, @SuppressLint("RecyclerView") final int position) {
